...
def start_game():
  ...
  result=img_search_utils.searchImg('lineage_symbol.png',beforeDelay=0, afterDelay=4, _region=(0,0,1920,1080), accuracy=0.7)
  result=img_search_utils.searchImg('game_start_1.png',beforeDelay=0, afterDelay=1, _region=(0,0,1920,1080))
